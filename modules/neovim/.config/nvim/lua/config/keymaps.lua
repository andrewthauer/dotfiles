...
map("i", "<A-j>", "<esc><cmd>m .+1<cr>==gi", { desc = "Move line(s) down", noremap = true })
map("i", "<A-k>", "<esc><cmd>m .-2<cr>==gi", { desc = "Move line(s) up", noremap = true })
...
-- floating terminal
local lazyterm = function() Util.terminal(nil) end
