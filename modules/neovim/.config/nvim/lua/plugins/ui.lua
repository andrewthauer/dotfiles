...
return {
  ...
  -- https://github.com/folke/snacks.nvim
  {
    ...
    keys = {
      ...
      -- find (custom)
      { "<leader>f.", function() Snacks.picker.files({ dirs = { "~/.dotfiles" }, hidden = true }) end, desc = "Find Dotfiles" },
      -- git
      ...
      -- conflicts with native gr mappings: grn (rename), grr (references), gri (implementations)
...
░▀░▀░▀▀▀░▀▀▀░░▀░░▀▀▀░▀░▀]],
          keys = {
            ...
            { icon = " ", key = "s", desc = "Restore Session", action = function() require("session_manager").load_current_dir_session(false) end },
