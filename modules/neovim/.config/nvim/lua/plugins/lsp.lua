  ...
  -- https://github.com/neovim/nvim-lspconfig
  {
    ...
    config = function(_, opts)
      ...
      lsp_zero.on_attach(function(client, bufnr)
        ...
        -- custom key maps
        util.set_keymaps(M.get_lsp_keymaps())
      end)
...
function M.get_lsp_keymaps()
  return {
    ...
    -- From lsp-zero
    --
    { "n", "<F2>", "<cmd>lua vim.lsp.buf.rename()<cr>", { desc = "Rename symbol" } },
    -- { "n", "<F3>", "<cmd>lua vim.lsp.buf.format({async = true})<cr>", { desc = "Format file" } },
    -- { "n", "<F3>", "<cmd>lua vim.lsp.buf.format({async = true})<cr>", { desc = "Format selection", mode = "x" } },
    { "n", "<F4>", "<cmd>lua vim.lsp.buf.code_action()<cr>", { desc = "Execute code action" } },
    ...
    { "n", "<C-k>", vim.lsp.buf.signature_help, mode = "i", desc = "Signature Help", has = "signatureHelp" },
    ...
    { "n", "go", require("telescope.builtin").lsp_type_definitions, { desc = "Type [D]efinition" } },
    ...
    { "n", "gs", vim.lsp.buf.signature_help, { desc = "Signiture Function Help" } },
    ...
    { "n", "<leader>cc", vim.lsp.codelens.run, desc = "Run Codelens", mode = { "n", "v" }, has = "codeLens" },
